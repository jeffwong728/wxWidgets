...
if(WXGTK AND WIN32 AND MSVC)
    ...
    if (GTK_FOUND)
        message(STATUS "Found GTK${GTK_VERSION} include dirs ${GTK_INCLUDE_DIR}")
        message(STATUS "Found GTK${GTK_VERSION} libraries ${GTK_LIBRARIES}")
    endif()
    list(APPEND wxTOOLKIT_INCLUDE_DIRS ${GTK_INCLUDE_DIR})
    list(APPEND wxTOOLKIT_LIBRARIES ${GTK_LIBRARIES})
    list(APPEND wxTOOLKIT_DEFINITIONS ${GTK_DEFINITIONS})
    list(APPEND wxTOOLKIT_DEFINITIONS __WXGTK__)
    set(wxTOOLKIT_VERSION ${GTK_VERSION})
endif()
